...
# Ausgabedatei
ausgabe_csv <- file.path(work_dir, "02_daten", "training", "samples_corine_2018_variante_e.csv")
...
cat("Klasseneinteilung (Variante E):\n")
print(class_map)
cat("\n")
...
cat("  Anzahl Polygone:", nrow(polygon_metadaten), "\n")
cat("  Originale Code_18 Werte:", paste(unique(polygon_metadaten$Code_18), collapse = ", "), "\n\n")
...
cat("Nächster Schritt: RF-Modell trainieren (05_train_rf_corine_only.R)\n")
