...
# Ausgabedateien
model_output <- file.path(work_dir, "02_daten", "modelle", "xgb_model_corine_only_variante_e.rds")
metrics_output <- file.path(work_dir, "03_ergebnisse", "interne_validierung", "xgb_corine_only_variante_e_metrics.txt")
feature_list_path <- file.path(work_dir, "02_daten", "modelle", "xgb_corine_only_variante_e_features.rds")
...
cat("===========================================\n")
cat("XGBoost Training (CORINE only)\n")
...
sink(metrics_output)
cat("XGBoost Training (CORINE only, Variante E)\n")
cat("===========================================\n\n")
