...
model_output <- file.path(work_dir, "02_daten", "modelle", "xgb_model_corine_dgm_variante_b.rds")
feature_list_path <- file.path(work_dir, "02_daten", "modelle", "xgb_corine_dgm_variante_b_features.rds")

cat(">> Training XGBoost mit DGM (Variante B)\n")
